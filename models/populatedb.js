...
var drareaofspecializations = [];
var draddresss= [];
var drqualifications = [];

function drbiodataCreate(firstname, lastname, othernames, dateofbirth, sex, maritalstatus, callback)
{
         
    var drbiodatadetail = {firstname:firstname , lastname: lastname, othernames: othernames, dateofbirth: dateofbirth, sex: sex, maritalstatus: maritalstatus, callback}; 
  
if (dateofbirth !== null) 
{
    drbiodatadetail.dateofbirth = dateofbirth;
}
   
  var drbiodata = new DrBiodata(drbiodatadetail);
  ...
  drbiodata.save(function (err) {
    ...
    console.log('New Dr: ' + drbiodata);
    drbiodatas.push(drbiodata);
    callback(null, drbiodata);
  }  );
  }
